...
class Battery():
  ...
  def get_range(self):
    ...
    if self.battery_size == 70:
      ...
      print("Você vai ficar sem bateria")

    message = "This car can go approximately " + str(range)
    message += " miles on a full charge."
    print(message)

  def upgrade_battery(self, update ):
    
    if update >= self.battery_size:
      self.battery_size = update
    else:
      print("You can't roll back an odometer!")
...
my_tesla.battery.upgrade_battery(204)
# my_tesla.update_odometer(201)
